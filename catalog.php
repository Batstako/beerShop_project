...
<div id="main_container" class='container' style="margin: 150px auto; text-align: center;">
  <div style="position:fixed; margin-left: 50%;"><h3 id="money" style="vertical-align: 0.7em; display: inline-block;">Current balance: <?= $user['wallet'] ?> BGN</h3> <img id="wallet" src="images/wallet_card.png" style="width: 10%; cursor: pointer;" /></div>
